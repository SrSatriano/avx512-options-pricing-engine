...
1. Envie descrição detalhada para o mantenedor via GitHub Security Advisories ou contato privado do repositório [avx512-options-pricing-engine](https://github.com/SrSatriano/avx512-options-pricing-engine).
